...
// --------------------------------------------------------------------------------------
// Text checken, wenn Enter gedr�ckt wurde
// --------------------------------------------------------------------------------------
...
void ConsoleClass::ScrollUp(void)
{
    ...
    // Und unterste Zeile mit der letzten eingabe f�llen
