...
TimerClass				Timer;						    // Timer Klasse f�r die Framerate
#if defined(__AROS__)
...
ProjectileListClass		Projectiles;					// Liste mit Sch�ssen
...
int main(int argc, char *argv[])
{
	...
	int len = strlen(argv[0]);
        g_storage_ext = (char*)malloc(len + 1);
        strcpy_s(g_storage_ext, dirname(argv[0]));
#else
        g_storage_ext = (char*)malloc(strlen(".") + 1);
        strcpy_s(g_storage_ext, ".");
#endif
